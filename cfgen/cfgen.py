...
class GrammarModel(object):
    ...
    def __init__(self, corpus_path, model_order, clean_text=False):
        ...
        self.corpus_list = self.clean_corpuslist(corpus_path)
    ...
    def make_kgram_table(self, clean=True):
        ...
        return kgrams
    def clean_corpuslist(self, path, make_lowercase=True):
    ...
    def make_terminal_rules(self):
        ...
        for tag in tags:
            ...
            if gr_rule not in all_rulesl:
                all_rulesl.append(gr_rule)
